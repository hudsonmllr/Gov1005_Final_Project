...
save("Fig1_DOD_data", file = "FPShiny/Fig1_DOD_data.Rdata")
```

```{r, CH9: Figure 1 (Race), echo=FALSE}
...
Fig1_white <- Fig1_joined_data_bg %>% ggplot(aes(year, white, color=group)) + geom_line() + theme_minimal() + scale_x_continuous(breaks=c(1970, 1975, 1980, 1985, 1990, 1995, 2000, 2005, 2010, 2015), labels=c(1970, 1975, 1980, 1985, 1990, 1995, 2000, 2005, 2010, 2015)) + labs(x="Year") + scale_color_discrete(labels=c("Civilian Population\n(18-24 Years Old)","Undergraduate College Students","Enlisted Military\n(Non-prior Service Accession)"))

Fig1_black <- Fig1_joined_data_bg %>% ggplot(aes(year, black, color=group)) + geom_line() + theme_minimal() + scale_x_continuous(breaks=c(1970, 1975, 1980, 1985, 1990, 1995, 2000, 2005, 2010, 2015), labels=c(1970, 1975, 1980, 1985, 1990, 1995, 2000, 2005, 2010, 2015)) + labs(x="Year") + scale_color_discrete(labels=c("Civilian Population\n(18-24 Years Old)","Undergraduate College Students","Enlisted Military\n(Non-prior Service Accession)"))

Fig1_hispanic <- Fig1_joined_data_bg %>% ggplot(aes(year, hispanic, color=group)) + geom_line() + theme_minimal() + scale_x_continuous(breaks=c(1970, 1975, 1980, 1985, 1990, 1995, 2000, 2005, 2010, 2015), labels=c(1970, 1975, 1980, 1985, 1990, 1995, 2000, 2005, 2010, 2015)) + labs(x="Year") + scale_color_discrete(labels=c("Civilian Population\n(18-24 Years Old)","Undergraduate College Students","Enlisted Military\n(Non-prior Service Accession)"))

Fig1_other <- Fig1_joined_data_bg %>% ggplot(aes(year, other, color=group)) + geom_line() + theme_minimal() + scale_x_continuous(breaks=c(1970, 1975, 1980, 1985, 1990, 1995, 2000, 2005, 2010, 2015), labels=c(1970, 1975, 1980, 1985, 1990, 1995, 2000, 2005, 2010, 2015)) + labs(x="Year") + scale_color_discrete(labels=c("Civilian Population\n(18-24 Years Old)","Undergraduate College Students","Enlisted Military\n(Non-prior Service Accession)"))
...
Gen_Race_pct_enr <- Fall_1976_2017_pct %>% pivot_longer(names_to = "year",
               values_to = "Percent",
               cols = c(-Race, -Gender)) %>% filter(Race == "White" | Race == "Black" | Race == "Hispanic")

Gen_Race_pct_enr$Percent <- Gen_Race_pct_enr$Percent %>% round(1)

 Fig2 <- Gen_Race_pct_enr %>% filter(Gender == "Total") %>% ggplot(aes(year, Percent, color=Race)) + geom_point() + theme_bw() + labs(x="Year")

Fig2_interactive <- ggplotly(Fig2)
